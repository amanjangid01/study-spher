...
//         let {courseName,courseDescription,category,whatYouWillLearn,price,
//             tag:_tag,
//             status,
...
//         // update the user here user is instructor
...
const User=require("../models/User");
const {uploadImageToCloudinary}=require("../utils/imageUploader");
const { listenerCount } = require("../models/Profile");
...
exports.getFullCourseDetails = async (req, res) => {
  try {
    ...
    console.log("courseProgressCount : ", courseProgressCount)
    console.log("courseProgressCount : ", courseDetails)
